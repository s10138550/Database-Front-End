...
CREATE TABLE `rent` (
  `BooksCheckedOut` int NOT NULL,
  `BookTitle` varchar(40) DEFAULT NULL,
  `UserName` varchar(20) DEFAULT NULL,
  `DateCheckedOut` date DEFAULT NULL,
  `DateDueBack` date DEFAULT NULL,
  `LateFee` decimal(9,2) DEFAULT NULL,
  PRIMARY KEY (`BooksCheckedOut`),
  KEY `BookTitle_idx` (`BookTitle`),
  KEY `UserName_idx` (`UserName`),
  CONSTRAINT `BookTitle` FOREIGN KEY (`BookTitle`) REFERENCES `book` (`BookTitle`) ON DELETE CASCADE ON UPDATE CASCADE,

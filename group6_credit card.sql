...
CREATE TABLE `credit card` (
  ...
  `CreditCardType` char(20) DEFAULT NULL,
  `CVC` int DEFAULT NULL,
  `ExpirationDate` date DEFAULT NULL,
  PRIMARY KEY (`CreditCardNumber`),
  KEY `StreetAddress2_idx` (`Address`),
  CONSTRAINT `StreetAddress2` FOREIGN KEY (`Address`) REFERENCES `address` (`StreetAddress`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-11-05 15:55:14

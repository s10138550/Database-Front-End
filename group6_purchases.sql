...
CREATE TABLE `purchases` (
  ...
  PRIMARY KEY (`DatePurchased`),
  KEY `UserName3_idx` (`UserName`),
  KEY `BookTitle3_idx` (`BookTitle`),
  CONSTRAINT `BookTitle3` FOREIGN KEY (`BookTitle`) REFERENCES `book` (`BookTitle`) ON DELETE CASCADE ON UPDATE CASCADE,
